...
@endif
<form id="formAccountSettings" method="POST" enctype="multipart/form-data" action="{{route('create-new-student')}}">
    @csrf
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                ...
                <select id="defaultSelect" class="form-select" name="center"
                    ...
                    @foreach($franchiseId as $franchise)
                            <option value="{{ $franchise->franchise_id }}">{{ $franchise->franchise_id }}</option>
                    @endforeach
